...
class PokeAPI {
  ...
  static dynamic _mapJson<T>(Http.Response response) {
    ...
    if (T == BerryFirmness) {
      return BerryFirmness.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == BerryFlavor) {
      return BerryFlavor.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == Characteristic) {
      return Characteristic.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == EggGroup) {
      return EggGroup.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == Gender) return Gender.fromJson(map as Map<String, dynamic>) as T;
    if (T == GrowthRate) {
      return GrowthRate.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == Item) return Item.fromJson(map as Map<String, dynamic>) as T;
    if (T == ItemAbility) {
      return ItemAbility.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == ItemCategory) {
      return ItemCategory.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == ItemFlingEffect) {
      return ItemFlingEffect.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == ItemPocket) {
      return ItemPocket.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == Nature) return Nature.fromJson(map as Map<String, dynamic>) as T;
    if (T == PokeAthlonStat) {
      return PokeAthlonStat.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == Pokemon) return Pokemon.fromJson(map as Map<String, dynamic>) as T;
    if (T == PokemonColor) {
      return PokemonColor.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == PokemonForm) {
      return PokemonForm.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == PokemonHabitat) {
      return PokemonHabitat.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == PokemonShape) {
      return PokemonShape.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == PokemonSpecie) {
      return PokemonSpecie.fromJson(map as Map<String, dynamic>) as T;
    }
    ...
    if (T == ContestEffect) {
      return ContestEffect.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == ContestType) {
      return ContestType.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == SuperContestEffect) {
      return SuperContestEffect.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == EncounterCondition) {
      return EncounterCondition.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == EncounterConditionValue) {
      return EncounterConditionValue.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == EncounterMethod) {
      return EncounterMethod.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == EvolutionChain) {
      return EvolutionChain.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == EvolutionTrigger) {
      return EvolutionTrigger.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == Generation) {
      return Generation.fromJson(map as Map<String, dynamic>) as T;
    }
    ...
    if (T == VersionGroup) {
      return VersionGroup.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == Location) {
      return Location.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == LocationArea) {
      return LocationArea.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == PalParkArea) {
      return PalParkArea.fromJson(map as Map<String, dynamic>) as T;
    }
    ...
    if (T == MoveAilment) {
      return MoveAilment.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == MoveBattleStyle) {
      return MoveBattleStyle.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == MoveCategory) {
      return MoveCategory.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == MoveDamageClass) {
      return MoveDamageClass.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == MoveLearnMethod) {
      return MoveLearnMethod.fromJson(map as Map<String, dynamic>) as T;
    }
    if (T == MoveTarget) {
      return MoveTarget.fromJson(map as Map<String, dynamic>) as T;
    }
  }
  ...
  static Future<List<NamedAPIResource>?> getCommonList<T>(
    ...
    List<NamedAPIResource>? commonResultList =
        Common.fromJson(listMap as Map<String, dynamic>).results;
